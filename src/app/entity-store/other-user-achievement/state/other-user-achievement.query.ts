...
import { OtherUserAchievementState, OtherUserAchievementStore } from './other-user-achievement.store';
...
export class OtherUserAchievementQuery extends QueryEntity<OtherUserAchievementState, OtherUserAchievementModel> {
  componentName = 'other-user-achievement.query';
  ...
  constructor(protected store: OtherUserAchievementStore) {
    super(store);
  }


  private getVisibleAchievements(filter, achievements): OtherUserAchievementModel[] {
    switch (filter) {
  ...
  filterAchievements(): Observable<OtherUserAchievementModel[]> {
    return new Observable<any>(observer => {
      ...
      const filteredList: OtherUserAchievementModel[] = [];
  ...
  getAchievementFamilyCount(achievement: OtherUserAchievementModel): OtherUserAchievementModel[] {
  ...
  getCompleteAchievements(): OtherUserAchievementModel[] {
